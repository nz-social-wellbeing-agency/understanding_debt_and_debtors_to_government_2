...
# file paths
ABSOLUTE_PATH_TO_TOOL <- "~/Network-Shares/DataLabNas/MAA/MAA2020-01/debt to government_Phase2/rprogs"
ABSOLUTE_PATH_TO_ANALYSIS <- "~/Network-Shares/DataLabNas/MAA/MAA2020-01/debt to government_Phase2/rprogs"
#POPULATION_FILE <- "population_and_period.xlsx"
#MEASURES_FILE <- "measures.xlsx"
POPULATION_FILE <- "population_and_period_Household.xlsx"
MEASURES_FILE <- "measures_Household.xlsx"

# outputs
OUTPUT_DATABASE <- "[IDI_Sandpit]"
OUTPUT_SCHEMA <- "[DL-MAA2020-01]"
#LONG_THIN_TABLE_NAME <- "[d2gP2_assembled_data]"
#RECTANGULAR_TABLE_NAME <- "[d2gP2_rectangular]"
#RECTANGULAR_TABLE_NAME <- "[d2gP2_rectangular_May]"
#LONG_THIN_TABLE_NAME <- "[d2gP2_assembled_data_July]"
#RECTANGULAR_TABLE_NAME <- "[d2gP2_rectangular_July]"
LONG_THIN_TABLE_NAME <- "[d2gP2_assembled_data_hhld]"
RECTANGULAR_TABLE_NAME <- "[d2gP2_rectangular_hhld]"
